...
def fdm_login(host,username,password):
	...
	request = requests.post("https://{}:{}/api/fdm/v2/fdm/token".format(host, FDM_PORT),json=payload, verify=False, headers=headers)
...
def fdm_get_hostname(host,token):
	'''
	...
	try:
		request = requests.get("https://{}:{}/api/fdm/v2/devicesettings/default/devicehostnames".format(host, FDM_PORT),
...
if __name__ == "__main__":
	...
	print ('==========================================================================================')
	print()
	hostname = fdm_get_hostname(FDM_HOST,token)
